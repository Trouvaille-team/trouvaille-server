...
This is the boilerplate project used for starting new projects!
...
5. Move the example Environment file to the `.env` that will be ignored by git and read by the express server `mv example.env .env`
